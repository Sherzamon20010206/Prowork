    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort', models.CharField(blank=True, max_length=300, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='workpage.type')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='DocFile')),
                ('slug', models.SlugField(blank=True, max_length=125, null=True)),
                ('sort', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='workpage.sort')),
            ],
        ),
    ]
